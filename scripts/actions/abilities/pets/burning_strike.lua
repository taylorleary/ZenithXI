...
abilityObject.onPetAbility = function(target, pet, petskill, summoner, action)
    ...
    local damage     = math.floor(baseDamage.damage + pet:getStat(xi.mod.INT) - target:getStat(xi.mod.INT))
    ...
    damage = xi.summon.avatarFinalAdjustments(info, pet, petskill, target, xi.attackType.PHYSICAL, xi.damageType.BLUNT, 1)
