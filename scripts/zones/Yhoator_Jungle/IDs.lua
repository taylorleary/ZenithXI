...
zones[xi.zone.YHOATOR_JUNGLE] =
{
    text =
    {
        ...
        SOMETHING_IS_BURIED_HERE      = 7742,  -- It looks like something is buried here. If you had <item> you could dig it up.
        GARRISON_BASE                 = 7752,  -- Hm? What is this? %? How do I know this is not some [San d'Orian/Bastokan/Windurstian] trick?
        TIME_ELAPSED                  = 7799,  -- Time elapsed: <number> [hour/hours] (Vana'diel time) <number> [minute/minutes] and <number> [second/seconds] (Earth time)
        PLAYER_OBTAINS_ITEM           = 7831,  -- <name> obtains <item>!
        UNABLE_TO_OBTAIN_ITEM         = 7832,  -- You were unable to obtain the item.
        PLAYER_OBTAINS_TEMP_ITEM      = 7833,  -- <name> obtains the temporary item: <item>!
        ALREADY_POSSESS_TEMP          = 7834,  -- You already possess that temporary item.
        NO_COMBINATION                = 7839,  -- You were unable to enter a combination.
        UNITY_WANTED_BATTLE_INTERACT  = 7901,  -- Those who have accepted % must pay # Unity accolades to participate. The content for this Wanted battle is #. [Ready to begin?/You do not have the appropriate object set, so your rewards will be limited.]
        REGIME_REGISTERED             = 10017, -- New training regime registered!
        COMMON_SENSE_SURVIVAL         = 11136, -- It appears that you have arrived at a new survival guide provided by the Adventurers' Mutual Aid Network. Common sense dictates that you should now be able to teleport here from similar tomes throughout the world.
    },
    mob =
    {
