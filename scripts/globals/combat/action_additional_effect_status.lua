...
local defaultsTable =
{
    [xi.effect.AMNESIA      ] = { xi.subEffect.AMNESIA         },
    [xi.effect.ATTACK_DOWN  ] = { xi.subEffect.ATTACK_DOWN     },
    [xi.effect.BIND         ] = { xi.subEffect.DARKNESS_DAMAGE },
    [xi.effect.BLINDNESS    ] = { xi.subEffect.BLIND           },
    [xi.effect.CURSE_I      ] = { xi.subEffect.CURSE           },
    ...
    [xi.effect.POISON       ] = { xi.subEffect.POISON          },
    [xi.effect.SILENCE      ] = { xi.subEffect.SILENCE         },
    [xi.effect.SLEEP_I      ] = { xi.subEffect.SLEEP           },
    [xi.effect.SLOW         ] = { xi.subEffect.SLOW            },
    [xi.effect.STUN         ] = { xi.subEffect.STUN            },
    [xi.effect.TERROR       ] = { xi.subEffect.PARALYSIS       },
    [xi.effect.WEIGHT       ] = { xi.subEffect.ATTACK_DOWN     },
}
...
local function validateParameters(fedData)
    ...
    params.message     = fedData.messageDamage or xi.msg.basic.ADD_EFFECT_STATUS
